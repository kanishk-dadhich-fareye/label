...
var CustomPagination = props => {
  ...
  }, props.paginationDetails.totalElements > 0 ? props.pageDetail.pageSize * props.pageDetail.current + 1 : props.paginationDetails.totalElements, " to ", props.pageDetail.pageSize * props.pageDetail.current + props.paginationDetails.numberOfElements, " of ", props.paginationDetails.totalElements), /*#__PURE__*/React.createElement(Dropdown, {
    overlay: menu,
    trigger: ['click']
