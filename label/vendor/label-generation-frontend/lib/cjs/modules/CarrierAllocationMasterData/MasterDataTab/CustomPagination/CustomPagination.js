...
const CustomPagination = props => {
  ...
  }, props.pageDetail.pageSize * props.pageDetail.current + 1, " to ", props.pageDetail.pageSize * props.pageDetail.current + props.paginationDetails.numberOfElements, " of ", props.paginationDetails.totalElements), /*#__PURE__*/_react.default.createElement(_antd.Dropdown, {
    overlay: menu,
    trigger: ['click']
